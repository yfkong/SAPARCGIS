...
# An ArcGIS tool for Delineating service areas
We have designed a tool in ArcGIS for Delineating service areas. Various algorithms are surpported:
...
3. Copy all the files in a file directory. 
